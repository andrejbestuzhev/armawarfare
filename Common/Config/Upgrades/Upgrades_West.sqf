...
if (!isNil "CTI_PRICES_UPGRADES_WEST") then {
	{
		if (_forEachIndex < count CTI_PRICES_UPGRADES_WEST) then { _c set [_forEachIndex, CTI_PRICES_UPGRADES_WEST select _forEachIndex]; };
	} forEach _c;
};
if (!isNil "CTI_PRICES_UPGRADE_TIMES_WEST") then {
	{
		if (_forEachIndex < count CTI_PRICES_UPGRADE_TIMES_WEST) then { _t set [_forEachIndex, CTI_PRICES_UPGRADE_TIMES_WEST select _forEachIndex]; };
	} forEach _t;
};
