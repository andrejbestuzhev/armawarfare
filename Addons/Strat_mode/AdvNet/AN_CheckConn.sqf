...
//--- Radio jammer: treat a jammed node as disconnected until its flag expires (serverTime: synced across machines)
if (serverTime < (_vehicle getVariable ["AN_Jammed", -1])) exitWith {false};
